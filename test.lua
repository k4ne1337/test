...
local function update()
	...
	if Toggles.EquipSignT.Value == true and Players.LocalPlayer.Backpack:FindFirstChild('DonateSign') then
...
local httpservice = game:GetService('HttpService')
queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/k4ne1337/test/main/test.lua'))()")
...
miscMain:AddInput('addBegMsgInput', {
    ...
    Tooltip = 'Will add a beg message',
...
miscMain:AddInput('autoThanksInput', {
    ...
    Tooltip = 'Will add a AutoThanks message',
...
miscMain:AddInput('webhookInputT', {
    ...
    Finished = false,
    Text = 'Webhook',
    Tooltip = 'Discord/Guilded webhook',
    Placeholder = 'Webhook',
})
